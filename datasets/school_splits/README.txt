Splits for the school data (fro
ac.uk/)
...
consisting of examination records from 140 secondary
 schools in years 1985,
1986 and 1987. It is a random 50% sample with 15362 students. The data have
been used to study 
the effectiveness of schools. The original file has the following format:
...
as binary attributes.
 The resulting data set has 27 attributes 
+ 1
...
Splits are
 in school_$i$_indexes.mat (i=1,...,10)


tr = training set indexes (for x in school_b.mat)

tst = test set indexes 
(for x in school_b.mat)
